...
function perguntarMovimento() { 
    rl.question('Digite o tipo (entrada/saida): ', function (tipo) {
        rl.question('Descrição: ', function (descricao) {
            rl.question('Valor: ', function (valor) {
                rl.question('Categoria (fixo/variavel): ', function (categoria) {
                    rl.question('Data (Dia-Mês-Ano): ', function (dataStr) {
                        const [dia, mes, ano] = dataStr
                            ...
                            rl.question(
                                'Deseja adicionar outro movimento? (s/n): ',
                                function (resp) {
